...
namespace SmosOS.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new CustomUser { UserName = Input.Email, Email = Input.Email, Familienaam = Input.Familienaam, Voornaam = Input.Voornaam };
